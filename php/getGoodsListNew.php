<?php
	...
	//3）、传输数据（过桥）
	$sqlstr = "select goodsId,goodsName,gi.typeId,goodsPrice,goodsCount,goodsDesc,goodsImg ,beiyong1 ,beiyong2 ,beiyong3 ,beiyong4,
	                  beiyong5,beiyong6,beiyong7,beiyong8,beiyong9, beiyong10, beiyong11, beiyong12, beiyong13,gt.goodstype,goodsTime
	...
	$sqlstr .= " order by gi.goodsTime desc";
	$sqlstr .= " limit ".$count;
	...
	while($query_row){
		...
		,"beiyong12":"'.$query_row[18].'","beiyong13":"'.$query_row[19].'","goodsTime":"'.$query_row[21].'"
		}';
